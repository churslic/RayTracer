...
public:
    ...
    static T Dot_Product(const Vector_2D& vector1,
                         const Vector_2D& vector2)
    {
...
public:
    ...
    static T Dot_Product(const Vector_3D& vector1,
                         const Vector_3D& vector2)
    {
    ...
    static Vector_3D Cross_Product(const Vector_3D& v1,
            const Vector_3D& v2) // 6 mults, 3 adds
    {
        return Vector_3D(v1.y*v2.z-v1.z*v2.y,v1.z*v2.x-v1.x
...
public:
    ...
    // left and right wall, bottom and top wall
    ...
    Grid_2D(int m_input,int n_input,double xmin_input,
            double xmax_input,double ymin_input,double ymax_input)
    {
...
public:
    ...
    // check for an intersection in the range [0,t_max] or [0,inf] if
